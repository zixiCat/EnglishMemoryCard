...
- self_responsibility - Help yourself.
- self_responsibility - Do it yourself.
- defensive_parry - You can parry (你可以招架)
- queue_order - Ma'am, back of the line
- avoid_corner - I know there's like items all round, so I got to not back myself into a corner.
- avoid_corner - Step one, don't back yourself into a corner. Step two, go into the houses and get the loot. Step three, use yours，make sure you kick them.
- tiny_slip - Whoopsie
- panic_survival - Excuse me, Excuse me, I am gonna die
- disbelief_real - Okay, is this is this real?
- map_check - Let me look at this freaking map
- space_here_contrast - There's just stuff in here vs There's just stuff here
- space_here_contrast - "In here" is contained. You are physically inside the space or looking into it. (/kənˈteɪnd/)
- space_here_contrast - "Here" is nearby. It is just the general spot where you are standing or pointing.
- enter_warning - Don't go in
- sneak_inside - And then we sneak in her house
- missed_spot - The one house I didn't go in, I'm gonna lose my mind
- missed_spot - Look, we even skipped his grand entry
