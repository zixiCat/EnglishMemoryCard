        ...
        <div className="fixed inset-0 z-50 flex justify-end">
          ...
          >
            <div className="flex items-start justify-between gap-4 border-b border-slate-200 pb-4 sm:gap-5 dark:border-slate-700">
              ...
              <button
                aria-label="Close remembered cards"
                className="flex min-h-12 min-w-12 items-center justify-center rounded-[16px] border border-slate-200 bg-white px-4 text-slate-700 transition hover:border-slate-300 dark:border-slate-700 dark:bg-slate-900 dark:text-slate-200 dark:hover:border-slate-600"
                onClick={onClose}
                type="button"
              >
                <X className="h-5 w-5" />
